      ...
      <div class="columns" v-else-if="publicLists.length > 0">
        <div class="column is-4">
          ...
          <template v-if="settings['app.enable_public_subscription_page']">
            ...
            <p>
              <a
                :href="`${settings['app.root_url']}/subscription/form`"
                target="_blank"
                data-cy="url"
                >{{ settings["app.root_url"] }}/subscription/form</a
              >
            </p>
          </template>
        </div>
        <div class="column" data-cy="form">
          ...
          >&lt;form method=&quot;post&quot; action=&quot;{{ settings['app.root_url'] }}/subscription/form&quot; class=&quot;listmonk-form&quot;&gt;
    &lt;div&gt;
        &lt;h3&gt;Subscribe&lt;/h3&gt;
