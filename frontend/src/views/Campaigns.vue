      ...
      >
        ...
        >
          <div class="fields timestamps" :set="(stats = getCampaignStats(props.row))">
            ...
            <p v-if="stats.startedAt && stats.updatedAt" class="is-capitalized" title="Duration">
        ...
        <b-table-column v-slot="props" field="stats" :label="$t('campaigns.stats')" width="18%">
          <div class="fields stats" :set="(stats = getCampaignStats(props.row))">
            ...
            <p title="Speed" v-if="stats.rate">
              ...
              <span class="send-rate"> {{ stats.rate.toFixed(0) }} / min </span>
            </p>
        ...
        <b-table-column v-slot="props" cell-class="actions" width="13%" align="right">
          <div>
            <a
              ...
              @click.prevent="
                $utils.confirm(null, () => changeCampaignStatus(props.row, 'running'))
              "
              data-cy="btn-start"
            >
            ...
            <a
              href=""
              v-if="canSchedule(props.row)"
              @click.prevent="
                $utils.confirm($t('campaigns.confirmSchedule'), () =>
            ...
            <a
              ...
              @click.prevent="
                $utils.confirm(null, () => changeCampaignStatus(props.row, 'cancelled'))
              "
              data-cy="btn-cancel"
            >
            ...
            <a
              href=""
              @click.prevent="
                $utils.confirm($tc('campaigns.confirmDelete'), () => deleteCampaign(props.row))
              "
              data-cy="btn-delete"
            >
  ...
  methods: {
    ...
    pollStats() {
      ...
      this.pollID = setInterval(() => {
        this.$api.getCampaignStats().then(
          data => {
