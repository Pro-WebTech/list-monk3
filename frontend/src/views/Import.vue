        ...
        <div class="import-help">
          ...
          <blockquote className="csv-example">
            <code className="csv-headers">
              <span>email,</span>
              <span>name,</span>
              <span>attributes</span> </code
            ><br />
            <code className="csv-row">
              <span>user1@mail.com,</span>
              <span>"User One",</span>
              <span>"{""age"": 42, ""planet"": ""Mars""}"</span> </code
            ><br />
            <code className="csv-row">
...
export default Vue.extend({
  ...
  methods: {
    ...
    isRunning() {
      if (this.status.status === "importing" || this.status.status === "stopping") {
        return true;
      }
      return false;
    },
    ...
    isFailed() {
      return this.status.status === "stopped" || this.status.status === "failed";
    },
